...
export default function PricingPage() {
  ...
  const plans = [
    ...
    },
    {
      ...
      desc: '15 AI travel plans, full access',
      cta: 'Choose Explorer',
      ctaStyle: 'border border-glass-border bg-white/5 hover:bg-white/10 text-foreground',
      highlight: false,
      features: [
        { text: '15 travel plans', included: true },
        { text: 'Full day-by-day itinerary', included: true },
        { text: 'Restaurant & dining picks', included: true },
        ...
        { text: 'Plan history & shareable links', included: true },
    ...
    },
    {
      ...
      desc: 'Unlimited plans, same great features',
      cta: 'Choose Nomad',
