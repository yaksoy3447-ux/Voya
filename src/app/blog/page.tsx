...
export default function BlogPage() {
  const posts = [
    ...
    {
      title: "10 Hidden Treasures in Japan You've Never Heard Of Before",
    ...
    {
      title: "Dubai Travel Guide: Gold Souks, Desert Dunes & Sky-High Ambition",
    ...
    { title: "Paris Travel Guide: Eiffel Tower, Hidden Bistros & Seine Sunsets", slug: "paris-travel-guide", excerpt: "Beyond the postcard shots — how to eat, wander, and fall in love with Paris the way locals do.", date: "April 14, 2026", author: "Rovago Team", readTime: "8 min read", category: "City Guide", image: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?q=80&w=1200&auto=format&fit=crop" },
    { title: "Tokyo Travel Guide: Neon Nights, Ramen & Cherry Blossom Streets", slug: "tokyo-travel-guide", excerpt: "From Shibuya's crossing to a quiet temple in Yanaka — the Tokyo that will genuinely surprise you.", date: "April 13, 2026", author: "Rovago Team", readTime: "9 min read", category: "City Guide", image: "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?q=80&w=1200&auto=format&fit=crop" },
    { title: "New York City Guide: Bagels, Boroughs & the Best Views in the World", slug: "new-york-travel-guide", excerpt: "How to do NYC without burning your budget — and which neighbourhoods to actually spend your time in.", date: "April 11, 2026", author: "Rovago Team", readTime: "8 min read", category: "City Guide", image: "https://images.unsplash.com/photo-1534430480872-3498386e7856?q=80&w=1200&auto=format&fit=crop" },
    { title: "Rome in 4 Days: Colosseum, Cacio e Pepe & the Art of Doing Nothing", slug: "rome-travel-guide", excerpt: "A first-timer's guide to the Eternal City — where to eat, what to skip, and how to find peace in the chaos.", date: "April 9, 2026", author: "Rovago Team", readTime: "7 min read", category: "City Guide", image: "https://images.unsplash.com/photo-1552832230-c0197dd311b5?q=80&w=1200&auto=format&fit=crop" },
    { title: "Barcelona Travel Guide: Gaudí, Tapas & the Perfect Seaside City", slug: "barcelona-travel-guide", excerpt: "How to balance the tourist icons with the local barrios — and why Barcelona rewards slow travellers most.", date: "April 8, 2026", author: "Rovago Team", readTime: "8 min read", category: "City Guide", image: "https://images.unsplash.com/photo-1583422409516-2895a77efded?q=80&w=1200&auto=format&fit=crop" },
    { title: "London Travel Guide: Pubs, Parks & the World's Best Free Museums", slug: "london-travel-guide", excerpt: "London can be done on any budget — if you know where to look. Here's the city through a traveller's honest eyes.", date: "April 7, 2026", author: "Rovago Team", readTime: "8 min read", category: "City Guide", image: "https://images.unsplash.com/photo-1486299267070-83823f5448dd?q=80&w=1200&auto=format&fit=crop" },
    { title: "Bangkok Travel Guide: Street Food, Temples & the City That Never Sleeps", slug: "bangkok-travel-guide", excerpt: "The chaos, the colour, the food — Bangkok is overwhelming in the best possible way. Here's how to embrace it.", date: "April 4, 2026", author: "Rovago Team", readTime: "9 min read", category: "City Guide", image: "https://images.unsplash.com/photo-1563492065599-3520f775eeed?q=80&w=1200&auto=format&fit=crop" },
    ...
    { title: "Santorini Travel Guide: Blue Domes, Volcanic Beaches & Aegean Sunsets", slug: "santorini-travel-guide", excerpt: "Yes, it's popular — but Santorini's magic is real. Here's how to experience it beyond the crowds.", date: "March 29, 2026", author: "Rovago Team", readTime: "7 min read", category: "Destinations", image: "https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?q=80&w=1200&auto=format&fit=crop" },
    ...
    { title: "Singapore Travel Guide: Hawker Centres, Gardens & Hyper-Modern Asia", slug: "singapore-travel-guide", excerpt: "The cleanest, greenest, most delicious city in Asia — Singapore defies every expectation and rewards every visit.", date: "March 26, 2026", author: "Rovago Team", readTime: "7 min read", category: "City Guide", image: "https://images.unsplash.com/photo-1508964942454-1a56651d54ac?q=80&w=1200&auto=format&fit=crop" },
    { title: "Marrakech Travel Guide: Souks, Riads & the Sahara on Your Doorstep", slug: "marrakech-travel-guide", excerpt: "Marrakech is a full sensory assault — in the most wonderful way. Here's how to navigate the magic.", date: "March 25, 2026", author: "Rovago Team", readTime: "8 min read", category: "City Guide", image: "https://images.unsplash.com/photo-1539020140153-e479b8c22e70?q=80&w=1200&auto=format&fit=crop" },
    { title: "Kyoto Travel Guide: Bamboo Groves, Geisha Districts & Temple Silence", slug: "kyoto-travel-guide", excerpt: "Japan's ancient capital moves at a different pace — one that reminds you why slow travel is always the right choice.", date: "March 23, 2026", author: "Rovago Team", readTime: "8 min read", category: "Destinations", image: "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4?q=80&w=1200&auto=format&fit=crop" },
    { title: "New Orleans Travel Guide: Jazz, Gumbo & the Most Spirited City in America", slug: "new-orleans-travel-guide", excerpt: "New Orleans doesn't just have culture — it IS culture. Music, food, architecture and pure unapologetic joy.", date: "March 22, 2026", author: "Rovago Team", readTime: "7 min read", category: "Experience", image: "https://images.unsplash.com/photo-1571893544028-06b07af6dade?q=80&w=1200&auto=format&fit=crop" },
    { title: "Budapest Travel Guide: Thermal Baths, Ruin Bars & the Danube at Dusk", slug: "budapest-travel-guide", excerpt: "Budapest might be Europe's most underrated capital — grand, dramatic, affordable and impossibly romantic.", date: "March 21, 2026", author: "Rovago Team", readTime: "7 min read", category: "City Guide", image: "https://images.unsplash.com/photo-1516483638261-f4dbaf036963?q=80&w=1200&auto=format&fit=crop" },
    { title: "Cappadocia Travel Guide: Hot Air Balloons, Cave Hotels & Martian Landscapes", slug: "cappadocia-travel-guide", excerpt: "Nowhere on earth looks quite like Cappadocia — and floating over it at sunrise is genuinely life-changing.", date: "March 19, 2026", author: "Rovago Team", readTime: "7 min read", category: "Experience", image: "https://images.unsplash.com/photo-1570939274717-7eda259b50ed?q=80&w=1200&auto=format&fit=crop" },
    { title: "Amalfi Coast Travel Guide: Clifftop Villages, Limoncello & Turquoise Water", slug: "amalfi-coast-travel-guide", excerpt: "The Amalfi Coast is one of the most beautiful places on earth — here's how to see it without the chaos.", date: "March 18, 2026", author: "Rovago Team", readTime: "8 min read", category: "Destinations", image: "https://images.unsplash.com/photo-1533105079780-92b9be482077?q=80&w=1200&auto=format&fit=crop" },
    ...
    { title: "Cape Town Travel Guide: Table Mountain, Wine Valleys & the Edge of Africa", slug: "cape-town-travel-guide", excerpt: "Cape Town is the kind of city that makes you question why you'd ever live anywhere else. Here's the full picture.", date: "March 15, 2026", author: "Rovago Team", readTime: "8 min read", category: "City Guide", image: "https://images.unsplash.com/photo-1580060839134-75a5edca2e99?q=80&w=1200&auto=format&fit=crop" },
    { title: "Seoul Travel Guide: K-Culture, Street Food Alleys & Hyper-Modern Tradition", slug: "seoul-travel-guide", excerpt: "Seoul moves faster than almost any city on earth — and rewards those who keep up with some of the best food and culture in Asia.", date: "March 13, 2026", author: "Rovago Team", readTime: "8 min read", category: "City Guide", image: "https://images.unsplash.com/photo-1538485399081-7191377e8241?q=80&w=1200&auto=format&fit=crop" },
