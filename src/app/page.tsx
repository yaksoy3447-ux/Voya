...
export default function LandingPage() {
  ...
  const allExperiences = [
    ...
    { id: 2,  type: 'klook',  title: "Shibuya Sky Views",          loc: "Tokyo, Japan",         tag: "Trending",       img: "https://images.unsplash.com/photo-1542051841857-5f90071e7989?q=80&w=800&auto=format&fit=crop", link: "https://www.klook.com/en-US/search/result/?query=Shibuya+Sky+Observation+Deck+Tokyo&marker=715711" },
    { id: 3,  type: 'klook',  title: "Warner Bros. Studios",       loc: "London, UK",           tag: "Family Favorite", img: "https://images.unsplash.com/photo-1486299267070-83823f5448dd?q=80&w=800&auto=format&fit=crop", link: "https://www.klook.com/en-US/search/result/?query=Warner+Bros+Studio+Tour+London+Harry+Potter&marker=715711" },
    { id: 4,  type: 'viator', title: "Grand Canyon Helicopter",    loc: "Las Vegas, USA",       tag: "Bucket List",    img: "https://images.unsplash.com/photo-1509316785289-025f5b846b35?q=80&w=800&auto=format&fit=crop", link: "https://www.viator.com/search/Grand+Canyon+Helicopter+Las+Vegas/?pid=P00121703&mcid=42383&medium=link" },
    { id: 5,  type: 'viator', title: "Colosseum Underground",      loc: "Rome, Italy",          tag: "History",        img: "https://images.unsplash.com/photo-1552832230-c0197dd311b5?q=80&w=800&auto=format&fit=crop", link: "https://www.viator.com/search/Colosseum+Underground+Rome/?pid=P00121703&mcid=42383&medium=link" },
    { id: 6,  type: 'klook',  title: "Burj Khalifa Level 124",     loc: "Dubai, UAE",           tag: "Skyline",        img: "https://images.unsplash.com/photo-1518684079-3c830dcef090?q=80&w=800&auto=format&fit=crop", link: "https://www.klook.com/en-US/search/result/?query=Burj+Khalifa+Level+124+Dubai&marker=715711" },
    { id: 7,  type: 'viator', title: "Sagrada Família Tour",       loc: "Barcelona, Spain",     tag: "Most Booked",    img: "https://images.unsplash.com/photo-1583422409516-2895a77efded?q=80&w=800&auto=format&fit=crop", link: "https://www.viator.com/search/Sagrada+Familia+Barcelona/?pid=P00121703&mcid=42383&medium=link" },
    { id: 8,  type: 'viator', title: "Santorini Sunset Sailing",   loc: "Santorini, Greece",    tag: "Romantic",       img: "https://images.unsplash.com/photo-1530841377377-3ff06c0ca713?q=80&w=800&auto=format&fit=crop", link: "https://www.viator.com/search/Santorini+Sunset+Sailing/?pid=P00121703&mcid=42383&medium=link" },
    { id: 9,  type: 'viator', title: "Machu Picchu Guided Tour",   loc: "Cusco, Peru",          tag: "Bucket List",    img: "https://images.unsplash.com/photo-1526392060635-9d6019884377?q=80&w=800&auto=format&fit=crop", link: "https://www.viator.com/search/Machu+Picchu+Guided+Tour/?pid=P00121703&mcid=42383&medium=link" },
    { id: 10, type: 'klook',  title: "Sahara Desert Overnight",    loc: "Marrakech, Morocco",   tag: "Adventure",      img: "https://images.unsplash.com/photo-1489493585363-d69421e0edd3?q=80&w=800&auto=format&fit=crop", link: "https://www.klook.com/en-US/search/result/?query=Sahara+Desert+Tour+Marrakech&marker=715711" },
    { id: 11, type: 'klook',  title: "Phi Phi Islands Speedboat",  loc: "Phuket, Thailand",     tag: "Trending",       img: "https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?q=80&w=800&auto=format&fit=crop", link: "https://www.klook.com/en-US/search/result/?query=Phi+Phi+Islands+Speedboat+Phuket&marker=715711" },
    ...
    { id: 13, type: 'klook',  title: "Cappadocia Balloon Ride",   loc: "Cappadocia, Turkey",   tag: "Breathtaking",   img: "https://images.unsplash.com/photo-1570939274717-7eda259b50ed?q=80&w=800&auto=format&fit=crop", link: "https://www.klook.com/en-US/search/result/?query=Cappadocia+Hot+Air+Balloon&marker=715711" },
    { id: 14, type: 'viator', title: "Taj Mahal Sunrise Tour",    loc: "Agra, India",          tag: "Iconic",         img: "https://images.unsplash.com/photo-1564507592333-c60657eea523?q=80&w=800&auto=format&fit=crop", link: "https://www.viator.com/search/Taj+Mahal+Sunrise+Tour+Agra/?pid=P00121703&mcid=42383&medium=link" },
    { id: 15, type: 'viator', title: "Christ the Redeemer Tour",  loc: "Rio de Janeiro, Brazil", tag: "Must See",      img: "https://images.unsplash.com/photo-1483729558449-99ef09a8c325?q=80&w=800&auto=format&fit=crop", link: "https://www.viator.com/search/Christ+the+Redeemer+Rio+de+Janeiro/?pid=P00121703&mcid=42383&medium=link" },
  ]
              ...
              <motion.div key={tour.id} initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }}
                ...
                <a href={tour.link} target="_blank" rel="noopener noreferrer" className="absolute inset-0 z-20 flex flex-col justify-end p-8 bg-linear-to-b from-transparent to-black/90">
                  <div className="relative z-30 space-y-3">
                    <span className={`text-[8px] font-bold text-white px-2.5 py-0.5 rounded-full uppercase ${tour.type === 'viator' ? 'bg-orange-600' : tour.type === 'gyg' ? 'bg-emerald-600' : 'bg-terracotta'}`}>{tour.tag}</span>
                    ...
                    <div className="flex items-center justify-between opacity-0 group-hover:opacity-100 transition-all duration-500">
                       <span className="text-[8px] text-white/50 uppercase">via {tour.type === 'gyg' ? 'GetYourGuide' : tour.type}</span>
